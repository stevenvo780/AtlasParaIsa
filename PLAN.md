...
La revisión privada activa es **V5 desde el 5 de septiembre de 2026, 21:08 UTC**. Integra producción material, herramientas, aprendizaje tecnológico y ciclo vital, con **reemplazo generacional observado en dos réplicas de quince días** después de corregir la preparación alimentaria local. Esta ventana acotada no demuestra continuidad indefinida. Este plan conserva visión y estado; [REGLAS.md](docs/REGLAS.md) define mecanismos y [EVIDENCIA.md](docs/EVIDENCIA.md) registra la comparación, las pruebas y el archivo del mundo anterior.
...
El objetivo ampliado sigue abierto: construir un mundo que mantenga sus propias redes de producción, aprenda, se diferencie socialmente y descubra procedimientos ejecutables sin supervisión. V5 conserva vecinos de quinta generación en ambas réplicas corregidas, sin rescates y después de morir los fundadores mortales. Persisten el catálogo tecnológico finito y ventanas de organización incompletas. Un reemplazo observado durante quince días, una suite aprobada y una capacidad activa son evidencias distintas.
...
| Muerte, pérdida y otras relaciones reales | Ciclo vital y genealogía persistente implementados en V5 activo; reemplazo generacional observado en las dos réplicas corregidas de quince días. S e I conservan protección explícita; cambiar su significado personal sigue siendo una decisión del autor. |
...
| 2. Historia propia | Recuerdos sintéticos, práctica, hábitos observados, comunidades, ayuda y conflicto reversible; descendencia hasta quinta generación, tecnología y legados observados en V5. | Continuidad fuera de la ventana estudiada, transmisión y redes productivas sostenidas; selección real de recuerdos, nombres y rasgos. |
...
| Evolución continuada y reemplazo generacional | Demografía con costes heredables, nacimientos y archivo implementados. Las dos réplicas corregidas mantienen vecinos hasta quinta generación durante quince días; la continuidad indefinida y la selección genética aislada siguen sin acreditarse. La supervivencia protegida de S e I queda fuera del criterio de éxito. |
| Calidad visual excelsa, animación y mundo cambiante | V5 activo incorpora luz continua, sombras, agua, clima, vegetación y acciones vinculadas al servidor. Comparación gráfica y navegador comprobados; teléfono físico y calidad final pendientes. |
...
La comparación repetida después de corregir alimento y preparación familiar acredita reemplazo generacional dentro de la ventana estudiada. Una extensión a veinticinco días con dos semillas está **en ejecución, sin resultado todavía**. El siguiente avance debe resolver el catálogo saturado y la evidencia material incompleta, manteniendo costes, percepción local y ausencia de rescates. La arquitectura de memoria finita propone separar identidad de recetas y caché, archivar recibos de forma transaccional, conservar inventarios iniciales completos, permitir aprendizaje y redescubrimiento locales y orientar trabajo y diversidad por necesidad y utilidad observadas. Un ensayo de inventarios de apertura está en un worktree aislado; **no está integrado en main ni en V5 activo**. Los siete frentes y sus criterios están una sola vez en [CONSTRUCCION](docs/CONSTRUCCION.md#siguiente-arquitectura-propuesta-no-implementada); sus bases científicas están en [CIENCIA](docs/CIENCIA.md#investigación-pendiente-diversidad-y-continuidad-causal).
