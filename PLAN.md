...
La revisión privada activa continúa en V4. El candidato V5 integra producción material, herramientas, aprendizaje tecnológico y ciclo vital, pero está **en corrección / sin validar autonomía prolongada**: las dos réplicas de quince días perdieron todos los vecinos. Este plan conserva visión y estado; [REGLAS.md](docs/REGLAS.md) define mecanismos y [EVIDENCIA.md](docs/EVIDENCIA.md) registra pruebas, resultados negativos y la compatibilidad pendiente con la base privada.

Fecha: 5 de septiembre de 2026. V5 permanece como candidato local; no hay activación ni migración privada V4→V5 acreditadas. Cierre personal de la carta, prueba en móvil físico y alojamiento definitivo pendientes.

El objetivo ampliado sigue abierto: construir un mundo que mantenga sus propias redes de producción, aprenda, se diferencie socialmente y descubra procedimientos ejecutables sin supervisión. V5 tiene integración comprobada y una observación autónoma corta, pero no reemplazo generacional sostenido. Se corrigen reservas alimentarias y preparación familiar; después deben repetirse las comparaciones. Un ciclo de producción observado, una suite aprobada y una capacidad activa son evidencias distintas.
...
| Muerte, pérdida y otras relaciones reales | Ciclo vital y genealogía persistente implementados en el candidato V5; continuidad generacional fallida en las dos réplicas largas. S e I conservan protección explícita; cambiar su significado personal sigue siendo una decisión del autor. |
...
| Invención funcional | Construcción con seis componentes y, en el candidato V5, programas materiales compuestos, herramientas e insumos derivados. Ambas búsquedas pagan costes y distinguen función prevista de utilidad observada. Sus catálogos finitos limitan invención; ampliarlos exige archivo y memoria local separables. |
...
El código V5 añade tecnología material, prácticas por procedimiento, mortalidad humana y archivo de identidades a la fauna, ecología y comunidades de V4. Usa reglas/protocolo 5 y SQLite 3; el servicio activo conserva las versiones V4/SQLite 2. La prueba corta acredita fabricación y cooperación; la prueba larga contradice la continuidad generacional esperada. El siguiente avance debe corregir ese resultado, sin reiniciar el mundo privado para ocultarlo.
...
| 2. Historia propia | Recuerdos sintéticos, práctica, hábitos observados, comunidades, ayuda y conflicto reversible; descendencia, tecnología y legados en V5. | Reemplazo generacional, transmisión y redes productivas sostenidas; selección real de recuerdos, nombres y rasgos. |
| 3. Continuidad | Servicio V4 persistente; candidato V5 con sesión revocable, SQLite transaccional, copia y recuperación comprobadas en escenarios aislados. | Compatibilidad con la copia privada actual, validación de las correcciones y activación registrada; alojamiento definitivo con proceso, HTTPS y disco persistentes. |
...
| Evolución continuada y reemplazo generacional | Demografía con costes heredables, nacimientos y archivo implementados. Las dos réplicas largas V5 terminan sin vecinos: en corrección / sin validar autonomía prolongada. La supervivencia protegida de S e I queda fuera del criterio de éxito. |
| Calidad visual excelsa, animación y mundo cambiante | El candidato V5 incorpora luz continua, sombras, agua, clima, vegetación y acciones vinculadas al servidor. Comparación gráfica y navegador comprobados; teléfono físico y calidad final pendientes. |
...
Primero, repetir la continuidad generacional después de integrar las correcciones locales de alimento y preparación, conservando semillas, costes y ausencia de rescates. En paralelo queda diseñada, **sin implementar**, una arquitectura para seguir inventando con memoria finita: separar identidad de recetas y caché, archivar recibos de forma transaccional, conservar inventarios iniciales completos, permitir aprendizaje y redescubrimiento locales, orientar trabajo por demanda real y explorar diversidad funcional con utilidad medida. Los siete frentes, sus posibles propietarios y criterios de fallo están una sola vez en [CONSTRUCCION](docs/CONSTRUCCION.md#siguiente-arquitectura-propuesta-no-implementada); sus bases científicas están en [CIENCIA](docs/CIENCIA.md#investigación-pendiente-diversidad-y-continuidad-causal).
