...
La revisión privada activa es **V5 `bf6431b`, con SQLite 4 y reglas/protocolo 5**, comprobada el 5 de septiembre de 2026 a las 22:55 UTC. La actualización conserva el mismo mundo, acceso y sesiones; añade inventarios de apertura, archivo tecnológico transaccional, índice ecológico en CPU y renovación de interfaz y paisaje. El reemplazo generacional de dos réplicas de veinticinco días corresponde al cierre biológico anterior `6d0e53b`; no demuestra continuidad indefinida ni incluye los cambios de archivo. [REGLAS.md](docs/REGLAS.md) define mecanismos y [EVIDENCIA.md](docs/EVIDENCIA.md) registra pruebas, migración, activación y límites.

Estado documental: 6 de septiembre de 2026. El inicio V5 del día 5 a las 21:08 creó un mundo nuevo autorizado y conservó el V4 inválido; no fue una migración V4→V5 exitosa. La actualización posterior a SQLite 4 conserva ese mundo V5 sin reiniciarlo. Cierre personal de la carta, móvil físico y alojamiento definitivo pendientes.

**Política vigente por decisión de Steven:** durante esta etapa de desarrollo, cada nueva versión de pruebas publicada empieza un mundo desde cero. Se resguardan por separado el mundo y la historia anteriores, se mantiene la contraseña y no se restaura un estado viejo encima del nuevo. Los reinicios por fallo y las reconexiones dentro de la misma versión recuperan su estado confirmado; esta política no reinicia el código ni Git. La publicación de `7d8777c` se prepara con ese criterio: todavía no se ha reiniciado la instancia `bf6431b`. [README](README.md#nuevas-versiones-de-pruebas) define el alcance operativo; EVIDENCIA registrará la ejecución cuando ocurra.

El candidato **`7d8777c`**, posterior a la integración `614b25d`, incorpora un núcleo corporal compartido por acciones humanas y animales, transiciones del suelo basadas en estados locales y un catálogo tecnológico resoluble desde SQLite. La memoria técnica local de 32 instrucciones y la caché de 256 definiciones ya participan en investigación, fabricación, enseñanza, uso y olvido; el catálogo histórico puede superar 256 recetas y generación 32. **Todavía no sustituye la revisión privada `bf6431b`, que conserva esos topes.** Pasaron la validación conjunta, el navegador y el smoke compilados, además de la continuación autónoma en copia. Activación privada y observaciones largas multisemilla del candidato siguen pendientes. [EVIDENCIA](docs/EVIDENCIA.md) identifica las fuentes y comprobaciones de cada estado.
...
| Invención funcional | Construcción con seis componentes y programas materiales compuestos, herramientas e insumos derivados en V5. Ambas búsquedas pagan costes y distinguen función prevista de utilidad observada. El candidato separa catálogo tecnológico histórico, caché y conocimiento local; los planos constructivos conservan su gramática y presupuesto actuales. |
...
El código V5 conecta tecnología material, prácticas por procedimiento, mortalidad humana, archivo de identidades, fauna, ecología y comunidades. El servicio activo usa reglas/protocolo 5 y SQLite 4, con recibos durables y nueva interfaz. La prueba larga del cierre biológico anterior conserva generaciones nuevas durante veinticinco días en ambas semillas; no acredita una sociedad autosostenida indefinidamente. La ampliación del catálogo tiene evidencia separada en el candidato, todavía sin activar.
...
| Empezar desde cero al publicar nuevas versiones de pruebas | Preferencia vigente de Steven durante esta etapa: mundo nuevo por versión publicada, historia anterior resguardada y contraseña estable. No sustituye recuperación por fallos, no restaura mundos viejos encima de nuevos y no reinicia el desarrollo ni Git. Primera aplicación de esta política todavía pendiente. |
...
| Inventar estructuras nuevas que cambien lo que el mundo puede hacer | V4 combina componentes funcionales. V5 ejecuta programas que transforman materiales, producen herramientas y reutilizan productos o catalizadores, pagando trabajo, materia y desgaste. El candidato continúa investigando después de llenar la caché; geometría constructiva libre y nuevos usos materiales siguen pendientes. |
...
| Calidad visual, escala coherente e interfaz renovada | Activos navegación y fichas reorganizadas, escala de árboles respecto al cuerpo, suelo por estados y estructuras por componentes y condición. La selección distingue inspección de copa y órdenes al suelo; los cuerpos siguen legibles entre árboles. Navegador privado comprobado; densidad visual del bosque, teléfono físico y calidad final siguen pendientes. |
| Continuidad territorial y aprovechamiento de CPU, multinúcleo y dos GPU | Índice CPU activo con paridad exacta y perfiles de clonación, motor y guardado; reduce tiempo en los pasos ecológicos medidos, sin aceleración universal ni atribuir variación de SQLite al kernel. El prototipo de escritura paralela perdió capacidad de avance y no está integrado. Regiones lejanas siguen congeladas; GPU y continuidad multiescala requieren implementación y medición propias. |
...
El servicio V5 empezó un mundo nuevo autorizado después de comprobar que el V4 privado era inválido, conservando íntegra su historia y el acceso existente. La nueva política de versiones de pruebas amplía el comienzo desde cero a cada publicación durante esta etapa, con respaldo previo y contraseña estable. No convierte un error de lectura o una extinción en motivo para borrar o repoblar silenciosamente una ejecución. Los detalles de cada activación están en EVIDENCIA.
