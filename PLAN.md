...
El candidato conjunto permite preparar y tener descendencia a vecinos afiliados a comunidades distintas cuando cumplen la confianza mutua y las demás condiciones existentes; conserva sus grupos, costes, edad y localidad. El [contraste local](docs/EVIDENCIA.md#confianza-entre-comunidades-contraste-local) identifica el efecto de retirar aquella barrera en un nacimiento, sin demostrar continuidad sostenida. Añade etapas de vida calculadas por el servidor y una lectura global de vecinos separada de S/I: falta de datos y ausencia de recambio posible por edad se hacen explícitas, sin prometer crianza ni cambiar cuerpos. La fuente `409ee8f` pasó **612/612 Node, 18/18 navegador compilado, tipos, build, smoke y 7/7 Python**; la comprobación conjunta de `e42e8bc`, que añade ajuste de etiquetas a 320 píxeles, sigue en curso. El servicio y su mundo `03470e3` permanecen intactos.
