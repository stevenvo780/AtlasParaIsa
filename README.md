...
**Prioridad actual: supervivencia y legibilidad.** El mundo observado perdió toda su población mortal: la captura del día 23 conserva solo S e I protegidos. Las muertes por sed se concentraron en los días 6 y 7, los nacimientos cesaron en el día 6 y el último vecino murió en el día 18. Se conservó una copia coherente y se suspendió la publicación preparada para corregir decisiones y representación con evidencia. El [diagnóstico](docs/EVIDENCIA.md#afinación-tras-el-colapso-del-mundo-observado) reúne métricas, cronología y límites; no se considera resuelto por tener pruebas automáticas verdes.

La versión activa conecta el archivo tecnológico con investigación y fabricación: 256 define la caché residente, mientras las identidades y generaciones tecnológicas pueden seguir creciendo en SQLite. Cada persona conserva hasta 32 instrucciones. La interfaz distingue ese conocimiento de los objetos que lleva y de los detalles disponibles en la vista. También están activos el núcleo corporal común de humanos y animales y las transiciones visuales del suelo basadas en estados locales. La revisión posterior de tres semillas a veinticinco días encontró extinción vecinal en todas; corregir la búsqueda local de agua conserva vecinos en dos, pero todavía requiere afinación. EVIDENCIA separa ese contrafactual de las pruebas compiladas y del servicio. El agua V6 integrada en el código principal no forma parte de esta publicación.
...
También están integrados los claros físicos y las arboledas, junto con una última visita del navegador vinculada a cada ejecución. El candidato V6 conjunto `9b40f4d` pasó 517 pruebas Node, 18 de navegador compilado, typecheck, build y smoke; su publicación está suspendida durante la afinación y el servicio sigue en V5. La continuidad ecológica fuera de los barrios humanos se conserva como trabajo V7 aplazado. La comparación real de CPU, workers y ambas GPU quedó como herramienta de laboratorio: no mostró una mejora robusta del tiempo completo y la simulación conserva CPU. [EVIDENCIA](docs/EVIDENCIA.md#comparación-física-de-cpu-y-ambas-gpu) separa las mediciones de las capacidades publicadas.
