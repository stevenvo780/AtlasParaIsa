...
El laboratorio demográfico puede aislar compromisos entre rasgos y comparar descendencia bajo condiciones controladas. Sus generaciones y semillas no equivalen por sí solas a generaciones del mundo autónomo completo. La observación corregida sí conserva vecinos hasta quinta generación después de perder a todos los fundadores mortales, durante quince días y sin rescates, en las dos semillas que antes acabaron sin vecinos. El cambio conjunto de preparación alimentaria, reserva y acercamiento respalda esa mejora dentro de la ventana; no identifica la contribución independiente de cada regla. Tampoco demuestra autosostenimiento indefinido ni aísla selección natural de deriva, mortalidad y efecto fundador. Los resultados y la anomalía de salida del ejecutor se conservan en [EVIDENCIA.md](EVIDENCIA.md).
