...
Estas referencias orientan mecanismos y preguntas del [objetivo rector](../GOAL.md). **V5 `bf6431b` está activo en la revisión privada**. El reemplazo generacional de dos ventanas de veinticinco días corresponde al cierre biológico anterior `6d0e53b`; la actualización de archivo no amplía esa observación. La aplicación no acredita organismos, sentimientos, conciencia ni fidelidad biográfica. Unidades y fórmulas son decisiones de diseño comprobables. [EVIDENCIA.md](EVIDENCIA.md) conserva comparación, extinción anterior y límites de autonomía.
...
V5 añade un espacio tecnológico distinto: programas que transforman lotes compuestos mediante ocho leyes de materiales. Las recetas empiezan ausentes; búsqueda, cruces y mutaciones combinan instrucciones e insumos observables, incluidos productos anteriores. Propiedades y geometría determinan capacidades de corte, unión, contención, aislamiento, abrasión y cultivo. La firma de un programa nuevo y una combinación nueva de capacidades miden diversidad dentro de ese lenguaje; no prueban utilidad, creatividad ilimitada ni invención fuera de sus leyes. El servicio privado `bf6431b` limita el catálogo a 256 recetas y generación tecnológica 32. El candidato `7d8777c` separa archivo, caché y memoria local para continuar más allá de esos topes; conserva leyes, presupuestos computacionales y una clasificación funcional finita. Sus ensayos están en [EVIDENCIA](EVIDENCIA.md#catálogo-resoluble-y-memoria-local-en-el-candidato).
