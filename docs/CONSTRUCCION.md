...
Estado de la revisión: **V5 `bf6431b` activo con SQLite 4**, conservando mundo, acceso y sesiones. Incluye aperturas de inventario, archivo tecnológico, índice ecológico en CPU y renovación de interfaz y paisaje. Reglas y protocolo siguen en 5. Las dos réplicas de veinticinco días pertenecen al cierre biológico anterior; catálogo finito y mantenimiento material sin acreditar siguen limitando la autonomía. [README](../README.md) conserva operaciones y [EVIDENCIA](EVIDENCIA.md) pruebas, actualización y archivo V4 inválido. Recuerdos sintéticos y alojamiento definitivo pendiente.
