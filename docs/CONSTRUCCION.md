...
Estado de la revisión: **`7d8777c` activo con SQLite 4 y reglas/protocolo 5**. Incluye aperturas de inventario, archivo tecnológico resoluble, caché de 256 definiciones, memoria técnica local de 32 instrucciones, núcleo corporal compartido, índice ecológico en CPU y paisaje basado en estados locales. La publicación inició un mundo normal desde cero y archivó el anterior junto a su build, conservando contraseña, acceso TLS y bloqueo de instancia. Las dos réplicas favorables de veinticinco días pertenecen al cierre biológico anterior. La revisión posterior del catálogo activo encontró extinción vecinal en tres semillas; la búsqueda de agua corregida conserva vecinos en dos y deja abierto el problema de exposición y recambio en la tercera. [README](../README.md) conserva operaciones y [EVIDENCIA](EVIDENCIA.md) identifica esas fuentes y comparaciones. La estabilidad conjunta, el contenido personal y el alojamiento definitivo siguen pendientes.

El código principal integra **V6 `95ff0d2`**, aún sin publicar. Mantiene SQLite 4 y añade el contrato de agua contenida descrito abajo. Sus 120 fuentes, pruebas y archivos de compilación comparados coinciden con `eefbbe2`, validado con 496/496 Node y 17/17 E2E; el build servido continúa siendo V5. [EVIDENCIA](EVIDENCIA.md#transporte-de-agua-v6-integrado) distingue esta integración de la publicación privada.
...
El protocolo **V6 del código principal** añade a cada producto un resumen opcional de agua: versión, cuantos contenidos, capacidad, escala de 50000 cuantos por unidad y fracción de fuga prevista por paso. Ausencia del resumen significa dato no disponible; cero significa vacío. El progreso de preparación usa la acción y el trabajo del habitante. El servidor publicado conserva protocolo V5 hasta la próxima release.
...
| 4. Caché y resolución — propietario de tecnología con contrato de archivo acordado | **Activo en `7d8777c`:** 256 es el presupuesto de definiciones residentes; generación 32 deja de ser un freno histórico. Se resuelven técnicas archivadas conservando límites de operaciones, entradas, trabajo, enteros seguros y memoria. | Se superan 256 identidades históricas y generación 32 mediante procesos pagados con caché acotada; reinicio, copias y cortes anteriores resuelven exactamente sus dependencias. La amplitud del archivo requiere medición propia. |
| 5. Aprendizaje y redescubrimiento — propietario de sociedad y aprendizaje | **Activo en `7d8777c`:** memoria de 32 instrucciones, recencia, olvido, protección de proyectos, enseñanza y redescubrimiento pagado sin acceso cognitivo global. La práctica se conserva solo con soporte local. Pendiente experimentar a partir de objetos desconocidos: `localInputs` aún exige conocer su receta; padres culturales y muestras materiales no son equivalentes. | Perder al último conocedor elimina fabricación sabida hasta enseñanza o redescubrimiento real; heredar o comprar un objeto no entrega su receta. Redescubrir un programa archivado conserva su ID y autoría, con otro recibo pagado. |
