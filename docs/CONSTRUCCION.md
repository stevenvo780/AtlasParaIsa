...
Estado publicado: [ESTADO.md](ESTADO.md). Antecedente de esta guía: `03470e3`, con SQLite 4 y reglas/protocolo 6, publicada y comprobada el 6 de septiembre de 2026. Conservaba aperturas de inventario, catálogo resoluble, caché de 256 definiciones, memoria local de 32 instrucciones, cuerpo compartido e índice ecológico en CPU. Añadía al alcance de la publicación agua contenida, claros, identidad de ejecución y afinaciones de elección y lectura. El candidato **`4a05bb5`**, que no entró en esa versión, añadía journal completo y validación incremental del archivo; pasó 606/606 Node, 18/18 navegador compilado, tipos, build y smoke. [README](../README.md) conserva operaciones y [EVIDENCIA](EVIDENCIA.md#matriz-v6-cerrada-a-veinticinco-días) separa publicación, integridad y matriz V6 cerrada: 30/18/1 vecinos finales, con la tercera semilla sin recambio posible. El contenido personal y el alojamiento definitivo siguen pendientes.
