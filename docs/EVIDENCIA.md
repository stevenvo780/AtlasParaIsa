...
Fecha de corte: **5 de septiembre de 2026**. El servicio privado ejecuta **V5 `bf6431b`, SQLite 4**, con reglas/protocolo 5. La actualización fue verificada a las **22:54:46 UTC**, conservando el mismo mundo, acceso y cuatro sesiones, sin reset. Archivo tecnológico, aperturas, índice ecológico y nueva interfaz están activos. Las dos réplicas de veinticinco días corresponden al cierre biológico anterior `6d0e53b`: conservaron vecinos de octava generación, pero no incluyen estos cambios. Persisten saturación tecnológica y mantenimiento material sin acreditar. El V4 inválido continúa archivado; su sustitución inicial por V5 y esta actualización del mismo V5 son operaciones distintas.
...
La comparación alimentaria, el soak con commit por paso, la extensión a veinticinco días y la actualización conservando el mundo están completados dentro de sus alcances. El candidato amplía el catálogo y conecta memoria local, pero faltan su activación privada, observaciones largas y multisemilla con esa memoria, recambio de herramientas y mantenimiento material reciente. El servicio activo conserva los topes de 256 recetas y generación 32. Tanto activo como candidato mantienen ecología lejana congelada y falta de simulación en GPU del servidor; el transporte de agua contenido aún se desarrolla de forma aislada.
