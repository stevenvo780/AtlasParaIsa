...
La base **`d9ebdb4`** añade un contrato de lectura del archivo, caché residente, estadísticas pendientes y resumen fijo de funciones tecnológicas. **12/12 pruebas focales** verifican evicción, referencias falsas o futuras, errores de estadísticas sin mutación parcial, preparación del commit y rechazo acotado de un prefijo corrupto. Un control encontró que un bitmap con huecos pasaba la validación; se corrigió y el negativo pasa. Estos ayudantes aún no están conectados al Store ni al ciclo autónomo: **el mundo conserva los topes de 256 recetas y generación 32**. No equivalen a una prueba de invención abierta ni de recuperación del catálogo ampliado.

## Trabajo y pruebas pendientes

La comparación alimentaria, el soak con commit por paso, la extensión a veinticinco días y la actualización conservando el mundo están completados dentro de sus alcances. Quedan continuidad fuera de esas trayectorias, transmisión aprendida, recambio de herramientas y mantenimiento material reciente. El archivo activo no resuelve esas propiedades por estar guardado; continúan el catálogo de 256 recetas, generación 32, ecología lejana congelada y falta de simulación en GPU del servidor.
