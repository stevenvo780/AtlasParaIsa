...
Este documento desarrolla la interacción y voz del [objetivo rector](../GOAL.md). **V6 `03470e3` está activa en la revisión privada para grabación**, publicada y comprobada el 6 de septiembre de 2026. Reúne archivo tecnológico, memoria local, agua transportable, claros y afinación de decisiones y lectura. [REGLAS.md](REGLAS.md) conserva mecánicas y [EVIDENCIA.md](EVIDENCIA.md#recambio-observado-después-de-la-afinación) pruebas, operación y recambio observado durante 113,35 días en una semilla. Las escenas no garantizan desenlaces ni continuidad indefinida. Calidad final, voz de Steven, biografía aprobada y teléfono físico siguen pendientes.
