...
Este documento desarrolla la interacción y voz del [objetivo rector](../GOAL.md). **V6 `03470e3` está activa en la revisión privada para grabación**, publicada y comprobada el 6 de septiembre de 2026. Reúne archivo tecnológico, memoria local, agua transportable, claros y afinación de decisiones y lectura. [REGLAS.md](REGLAS.md) conserva mecánicas y [EVIDENCIA.md](EVIDENCIA.md#publicación-para-grabación) pruebas, operación y límites. Esta fuente no tiene todavía un cierre demográfico de veinticinco días; las escenas no garantizan desenlaces ni continuidad indefinida. Calidad final, voz de Steven, biografía aprobada y teléfono físico siguen pendientes.
