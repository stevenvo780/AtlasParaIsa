...
Este documento desarrolla la interacción y voz del [objetivo rector](../GOAL.md). **V5 `7d8777c` está activo en la revisión privada**, con archivo tecnológico, memoria local y paisaje por estados. Su publicación comenzó un mundo nuevo y conservó el acceso. El código principal incorpora agua V6, todavía sin publicar. El reemplazo generacional de dos réplicas de veinticinco días corresponde al cierre biológico anterior. [REGLAS.md](REGLAS.md) conserva mecánicas y [EVIDENCIA.md](EVIDENCIA.md) pruebas y límites. Las escenas no garantizan desenlaces ni continuidad indefinida; calidad final, voz de Steven, biografía aprobada y teléfono físico siguen pendientes.

La revisión activa `7d8777c` distingue en la ficha lo que alguien recuerda, lo que lleva y los detalles que llegaron a la vista. El incidente posterior mostró que las copas ocultan instalaciones, que la ficha confunde la prioridad del agua del suelo frente a la cisterna y que el resumen de dos identidades protegidas puede ocultar la extinción de vecinos. La afinación candidata prioriza reservas y condición, revela la instalación seleccionada, distingue beneficio histórico de ocupación y declara la ventana reciente de las gráficas. [EVIDENCIA](EVIDENCIA.md#afinación-tras-el-colapso-del-mundo-observado) conserva escenas comparables y separa corrección visual de supervivencia.
