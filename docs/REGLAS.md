...
Cada diez pasos el desgaste reduce condición en 0.00018 con tiempo claro o 0.00028 bajo lluvia, dividido por durabilidad. Con condición menor o igual a 0.1 cesan las funciones. Una cisterna recoge hasta `0.012 × techos × condición` de lluvia, limitada por espacio libre; su grifo vierte hasta 0.018 al depósito potable de la celda, sin superar una reserva pública de 0.08 y debitando el depósito interno. Una huerta reparte hasta `0.008 × módulos × condición` de agua entre cuatro suelos vecinos hasta humedad 0.75; no crea alimento instantáneo.
...
Los usos con efectos reales actualizan una media acotada de utilidad. Las oportunidades culturales pueden transmitir un diseño observado; una obra en marcha conserva su receta. Producción, almacenamiento, consumo y beneficio corporal se registran por separado para poder comprobar su causalidad.
