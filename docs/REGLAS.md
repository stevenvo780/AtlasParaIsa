...
Estas reglas describen **V5 `bf6431b` activo en la revisión privada**, con preparación alimentaria local, inventarios de apertura y recibos durables. Archivo, índice ecológico e interfaz conservan reglas/protocolo 5; SQLite usa esquema 4. Las dos réplicas de veinticinco días corresponden al cierre biológico anterior; [EVIDENCIA.md](EVIDENCIA.md) separa lo probado, observado y activo. El [objetivo rector](../GOAL.md) conserva las capacidades pendientes. Las unidades no tienen equivalencia biológica demostrada ni puntúan el amor. La memoria y diferencias provisionales de S e I esperan la voz de Steven.
...
El guardado confirma recibos y snapshot juntos y solo entonces vacía la cola. El máximo de 65536 pendientes exige confirmar antes de continuar cuando se agota; no habilita pérdida silenciosa. Este control de almacenamiento no aporta materia ni modifica las leyes de fabricación. El adaptador todavía no consulta el archivo para recomponer épocas antiguas, por lo que siguen aplicando las aperturas y límites anteriores.

Archivar una receta no enseña a nadie ni elimina los límites actuales de catálogo y generación. Las funciones de memoria finita implementadas aún no participan en decisiones, enseñanza u olvido del mundo. Su integración y los ensayos pagados de redescubrimiento continúan pendientes.
