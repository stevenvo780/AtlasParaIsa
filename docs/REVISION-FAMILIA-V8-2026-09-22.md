...
bases/errores/timeout. No toca el lote reservado existente. Las tres semillas son diagnósticas y habían sido observadas antes de esta comparación; no son holdouts nuevos. No cambiar semillas,
...
toda diferencia temporal de extinción. Los resultados finales y su revisión independiente figuran arriba; el resultado mixto no acredita un cierre demográfico.
...
no miden capacidad del servidor. Los resultados completos están auditados en la primera sección de este informe.
