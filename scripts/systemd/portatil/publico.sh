...
# El acceso usa la credencial con hash ~/atlas-lab/mundos/v11-20260924/access.scrypt (npm run access -- init); nunca la contraseña en claro.
set -euo pipefail
cd "$HOME/atlas-lab/servidor"
export CARTA_DATA_DIR="$HOME/atlas-lab/mundos/v11-20260924" HOST=100.64.0.2 PORT=3000 CARTA_ORIGIN=https://atlas.humanizar.tech
