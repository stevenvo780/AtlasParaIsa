 ...
 */
export function stepEcosystem(tiles: Tile[], tick: number, weather: 'clear' | 'rain', phase: string, updateFauna = true, seed = 0, cuencas = 1): void {
  if (tick % 10 !== 0) return;
  ecosystemKernel.step(tiles, tick, weather, phase, seed, cuencas);
