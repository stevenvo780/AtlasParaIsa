...
const CLAVES_INSTRUMENTOS = ['diversidadConductaTiempo', 'diversidadConductaTiempoComponentes', 'diversidadConductaComponentes', 'repartoTiempoPorAccion', 'repartoActividadPorAccion'] as const;
